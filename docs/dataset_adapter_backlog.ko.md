...
4. **과목별 stress fixture pack**
   - 입력: 학년, 과목, standard ID에 매핑된 공개 안전 scenario
   - 출력: 수학, 국어, 과학, evidence-review skill용 reusable stress bank
   - 보호장치: stress pack은 candidate signal만 내며 promotion decision은 promotion engine에 남김
